...
open_rq.onupgradeneeded = function (e) {
    ...
    for (var i = 0; i < 5; i++) store.add({ idx: "object_" + i }, i);

    store.createIndex("", "idx");

    store.get(4).onsuccess = this.step_func(function (e) {
...
open_rq.onsuccess = function () {
    ...
    store.index("").get("object_4").onsuccess = this.step_func(function (e) {
        assert_equals(e.target.result.idx, "object_4", "result");
        this.done();
    });
};
